  ...
  <div style="border: 1px solid #ccc;">
    ...
    <div class="content">
      <div v-for="(item,index) in list" :key="index">
        ...
        <Editor style="height: 100px; overflow-y: hidden;" v-model="item['html'+item.index]" :defaultConfig="item['defaultConfig'+item.index]" :mode="item['mode'+item.index]" @onCreated="onCreated(item,editor)" @onChange="onChange" @onDestroyed="onDestroyed" @onMaxLength="onMaxLength" @onFocus="onFocus(item,editor)" @onBlur="onBlur" @customAlert="customAlert" @customPaste="customPaste" />
      </div>
